...
def predict_pic_result(pics_path=None):
    ...
    model.load_state_dict(torch.load("D:/openpose-master/build/workspace/model_pth/23classification_pic.pth", map_location='cpu'))
...
if __name__ == "__main__":
    ...
    pic_path = "D:/openpose-master/build/workspace/dataset/taichi/marked_pic/p_89_11.jpg"
